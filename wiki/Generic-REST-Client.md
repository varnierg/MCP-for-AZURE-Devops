...
Suppose you want to find how to manage repository branches (known as "Refs" in Git). Run `api.docs.search`:
...
Once you have the path, inspect its parameters and body using `api.info.get`:
